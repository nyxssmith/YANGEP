...
TEST_F(WalkcyclePNGLoadingTest, CanExtractFramesFromEachDirection)
{
    ...
    // All should be 64x64
    EXPECT_EQ(up_frame.w, 64);
    EXPECT_EQ(up_frame.h, 64);
    EXPECT_EQ(left_frame.w, 64);
    EXPECT_EQ(left_frame.h, 64);
    EXPECT_EQ(down_frame.w, 64);
    EXPECT_EQ(down_frame.h, 64);
    EXPECT_EQ(right_frame.w, 64);
    EXPECT_EQ(right_frame.h, 64);
}
